# Source: https://github.com/aonghena/Skiplagged-Flight-Scraper/blob/master/flightFinder.py

# Uses Selenium. I use the firefox driver: https://github.com/mozilla/geckodriver/releases
