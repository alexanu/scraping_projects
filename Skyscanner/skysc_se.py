...
class Scraper:
    ...
    def scrape_page(self, url):
        ...
        if self.sort_cheap is not None:
            try:
                cheapest_tab = self.driver.find_element(By.XPATH,self.sort_cheap)
                cheapest_tab.click()
                time.sleep(2)
...
class Skyscanner(Scraper):
    ...
    def close_popup(self):
        try:
            close = self.driver.find_element(By.CSS_SELECTOR,self.dialogbox_tag)
            close.click()
        except NoSuchElementException:
            pass
...
class Kayak(Scraper):
    ...
    def __init__(self):
        ...
        self.elem_present = EC.presence_of_element_located((By.CSS_SELECTOR,elem))
    ...
    def close_popup(self):
        ...
        try:
            ...
            close = self.driver.find_elements(By.CSS_SELECTOR,self.dialogbox_tag)
            try:
                close[-2].click()
